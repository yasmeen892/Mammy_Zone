        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContactFormId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClintPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClintMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventHours = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialistCertificate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Experience = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialistFacebookLinck = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialistInstgramLinck = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialistTwiterLinck = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkShopTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WorkShopPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WorkShopHours = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkShops_Specialists_SpecialistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Videoes", x => x.VideoId);
                    table.ForeignKey(
                        name: "FK_Videoes_WorkShops_WorkShopId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Videoes_WorkShopId",
                table: "Videoes",
                column: "WorkShopId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkShops_SpecialistId",
                table: "WorkShops",
                column: "SpecialistId");
        }
